...
interface SettingsManagerProps {
  ...
  onUpdateUserRole: (userId: string, newRole: "admin" | "user" | "writer" | "treasurer") => void;
                        ...
                        <tr key={u.id} className="hover:bg-stone-50/50 transition-all">
                          ...
                          <td className="py-3">
                            <select
                              ...
                              className="bg-stone-50 hover:bg-stone-100 border border-stone-200 text-stone-800 text-[11px] rounded px-2 py-1 focus:outline-none focus:border-red-800 font-semibold"
                            >
                              <option value="admin">👑 Chánh Tổng Quản (Admin)</option>
                              <option value="user">👥 Đinh Viên (User)</option>
                              <option value="writer">✍️ Sử Biên Ký (Writer)</option>
                              <option value="treasurer">💰 Thủ Quỹ Gia Tộc (Treasurer)</option>
                            </select>
                          </td>
                          <td className="py-3">
