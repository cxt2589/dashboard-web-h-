...
import { ZaloUser, ZaloAutoReply, ZaloBroadcast, FamilyMember, UserSession } from "../types";
...
export default function ZaloManager({ members = [], currentUser, usersList, onUpdateUsersList }: ZaloManagerProps) {
  ...
  const [subscribers, setSubscribers] = useState<ZaloUser[]>([
    { id: "z1", name: "Cao Văn Thịnh", phone: "0912345678", branch: "Chi Thứ Hai (Yên Khánh)", regDate: "28/05/2026", status: "Đang hoạt động", linkedMemberId: "m_11", relationship: "Con cháu trong họ", notes: "Trực hệ Chi Thứ Hai, cán bộ kỹ thuật nông nghiệp" },
    { id: "z2", name: "Cao Tiến Đạt", phone: "0987112345", branch: "Chi Trưởng (Trường Yên)", regDate: "25/05/2026", status: "Đang hoạt động", linkedMemberId: "m_1", relationship: "Bản thân", notes: "Thủ Quỹ, trưởng ban liên lạc Chi Trưởng" },
    { id: "z3", name: "Cao Thị Huyền Trang", phone: "0904432198", branch: "Chi Trưởng (Trường Yên)", regDate: "24/05/2026", status: "Đang hoạt động", notes: "Kế toán sự vụ, hỗ trợ tổng kê" },
    { id: "z4", name: "Cao Xuân Hưng", phone: "0888544332", branch: "Chi Thứ Ba (Gia Sinh)", regDate: "20/05/2026", status: "Đang hoạt động", notes: "Doanh nhân địa phương, tài trợ lăng bia" },
    { id: "z5", name: "Cao Minh Nhật", phone: "0934111333", branch: "Chi Thứ Ba (Gia Sinh)", regDate: "29/05/2026", status: "Chờ duyệt", notes: "Sinh viên năm 3 ĐHQG Hà Nội" },
    { id: "z6", name: "Cao Thị Lan", phone: "0345123987", branch: "Chi Trưởng (Trường Yên)", regDate: "15/05/2026", status: "Đang hoạt động", notes: "Cháu gái tạ gia" }
  ]);
  ...
  const handleSendBroadcast = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const activeSubsCount = subscribers.filter(s => s.status === "Đang hoạt động").length;
      const newBc: ZaloBroadcast = {
        id: "b_" + Date.now(),
        title: bcTitle,
        sentDate: new Date().toLocaleDateString("vi-VN"),
        recipientsCount: activeSubsCount,
        content: `${bcContent}\n\n[Tần suất: ${bcFrequency} | Lịch hẹn: ${bcScheduleTime}]`,
        category: bcCategory
      };
      ...
      alert(`Phát chiến dịch thành công! Con bối sẽ nhận lịch phát sóng qua Zalo theo tần suất [${bcFrequency}] vào thời điểm đặt [${bcScheduleTime}] với tổng số ${activeSubsCount} đinh tộc nhân nhận tin.`);
    }, 1500);
  };
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-stone-100">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 bg-red-800 hover:bg-red-950 text-white rounded px-3 py-1.5 font-bold cursor-pointer transition-colors shadow-xs"
                  >
